...
//			 int idJugador5 = s1.createJugador(new Jugador("Kiko Rivera", "kikorivera@gmail.com", 0));
//			 
//			 
...
//			Jugador j5 = new Jugador(idJugador5, "Kiko Rivera", "kikorivera@gmail.com", 0);
//			
//			
...
//			Partida p5 = new Partida(0, j5, LocalDate.now().minusDays(4), Resultado.TODOS);
//			Partida p6 = new Partida(0, j5, LocalDate.now().minusDays(5), Resultado.TODOS);
