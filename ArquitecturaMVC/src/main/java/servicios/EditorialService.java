...
import Comparators.ComparaEditorialNombreCif;
...
public class EditorialService {
	...
	public void editorialesOrdenadasPorNombre () {
		List<Editorial> lista = this.repoEditorial.getEditoriales().stream().collect(Collectors.toList());
		Collections.sort(lista, new ComparaEditorialNombreCif());
	}
