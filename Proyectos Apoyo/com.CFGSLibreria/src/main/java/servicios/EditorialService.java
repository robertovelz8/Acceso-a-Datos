...
public class EditorialService {
	private final Logger logger = LogManager.getLogger(EditorialService.class);
	...
	public List<Editorial> obtenerEditorialesOrdenadas() {
		Collections.sort(this.repoEditorial.getEditoriales().stream().collect(Collectors.toList()),
				Comparator.comparing(Editorial::getNombre).thenComparing(Editorial::getCif));
		return (List<Editorial>) repoEditorial;
	}
}
