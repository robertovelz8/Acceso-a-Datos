...
public class GestorEstudiante {
	...
	public static void main(String[] args) {
		...
		// Lo que debe aparecer son los estudiantes dos veces ya que estamos cogiedo una
		// lista donde ya estan esos estudiantes y estamos añadiedolos de nuevo,
		// tras cargar el archivo CSV y usar el metodo de escrituara CSV
		ue.cargarDatosCSV("EstudianteCSV.csv");
		ue.escriboCsv(listaEstudiantes, "PruebaCSV.csv");

		ue.escribeEstudiantesJSON(listaEstudiantes);
	}
}